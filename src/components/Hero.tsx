...
import { TrendingUp, Users, BarChart3, Building2, ArrowRight, ChevronDown } from 'lucide-react';
...
const dashboardMetrics = [
  ...
  { label: 'Taxa de Conversão', value: 34, suffix: '%', icon: TrendingUp, change: '+8.2%' },
  { label: 'CAC Médio', prefix: 'R$', value: 12, suffix: '', icon: BarChart3, change: '-31%' },
  { label: 'LTV Médio', value: 6, suffix: 'x', icon: Building2, change: '+2.1x' },
];
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            >
              ...
              previsível para empresas que querem escalar.
            </motion.h1>
            ...
            >
              Não entregamos apenas campanhas. Construímos sistemas completos de aquisição,
              conversão e escala para transformar sua empresa em uma máquina de crescimento.
            </motion.p>
            ...
            <motion.div custom={4} variants={fadeUp} initial="hidden" animate="show" className="mt-14 flex items-center gap-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm text-gray-400">Avaliação 4.9</span>
              </div>
            </motion.div>
          </div>
              ...
              <div className="glass-cyan rounded-3xl p-8 glow-cyan-subtle luxury-border">
                <div className="flex items-center justify-between mb-8">
                  <div>
                    ...
                    <p className="text-base font-semibold text-white">Março 2025</p>
                  </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-xs font-bold text-cyan-400">+47% vs mês anterior</span>
                  </div>
